countries = [
('Palestine', 'Al-Quds', 'Asia', 'Arabic', 5000000), ('Algeria',
...
'Africa', 'Arabic', 43000000), ('Syria', 'Damascus', 'Asia', 'Arabic',17000000),
('Tunisia', 'Tunis', 'Africa', 'Arabic', 11000000), ('United ArabEmirates', 'Abu Dhabi', 'Asia', 'Arabic', 10000000), ('Yemen', "Sana'a",
...
('Nigeria', 'Abuja', 'Africa', 'English', 200000000), ('Ethiopia', 'AddisAbaba', 'Africa', 'Amharic', 110000000), ('Albania', 'Tirana', 'Europe',
...
4105267), ('Cyprus', 'Nicosia', 'Europe', 'Greek, Turkish', 1189265), ('CzechRepublic', 'Prague', 'Europe', 'Czech', 10618303), ('Denmark', 'Copenhagen',
...
input_user = input("Enter a country name or capital to search: ")

for tup in countries:
    if input_user.title() == tup[0]  or input_user.title() == tup[1]:
        print(f'countery: {tup[0]} ')
        print(f'capital: {tup[1]}')
        print(f'continent: {tup[2]}')
        print(f'language: {tup[3]}')
        print(f'population: {tup[4]}')
        exit()
    
    if input_user.title() == tup[2]:
        print("this continent not countery")
        exit()
